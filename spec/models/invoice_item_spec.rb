...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe 'best_discount' do
    ...
    @ii_6 = InvoiceItem.create!(invoice_id: @invoice_5.id, item_id: @item_4.id, quantity: 10, unit_price: 5, status: 1)
    @ii_7 = InvoiceItem.create!(invoice_id: @invoice_6.id, item_id: @item_4.id, quantity: 10, unit_price: 5, status: 1)
